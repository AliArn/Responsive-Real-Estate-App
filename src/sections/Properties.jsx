...
const Properties = () => {
    ...
    return (
        <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
            ...
            <section id='properties' className='lg:w[90%] m-auto lg:px-20 px-6 py-20 w-full flex flex-col justify-center
        items-start gap-10'>
             ...
             dark:text-white'>Explore the Latest
                    </h1>
                </div>
                ...
                <div id='grid-box' className='w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8'>
                    {
                        property.map((item, index) => (
                            <div data-aos="zoom-in" data-aos-delay="200" key={index} className='bg-white dark:bg-gray-800 
                               rounded-xl w-full'>
                                <div id='image-box' className='bg-cover bg-center h-[250px] rounded-xl p-4 flex 
                                 flex-col justify-between items-end' style={{ backgroundImage: `url(${item.images})` }}>

                                    <div id='top' className='flex justify-between items-end w-full'>
                                        <div>
                                            <button className='px-3 py-1 bg-blue-600 hover:bg-white
                                              hover:text-black text-white rounded-full text-[15px]'>Featured
                                            </button>
                                        </div>
                                        ...
                                        <div className='flex justify-between items-center gap-3'>
                                            ...
                                            <button className='px-3 py-1 bg-blue-600 hover:bg-white
                                              hover:text-black text-white rounded-full text-[15px]'>Sales
                                            </button>

                                            <button className='px-3 py-1 bg-blue-600 hover:bg-white
                                              hover:text-black text-white rounded-full text-[15px]'>Active
                                            </button>
                                ...
                                <div className='px-6 py-3 flex flex-col  justify-center items-start gap-2 w-full'>
                                    ...
                                    <div id='owner-info' className='flex justify-between items-center w-full mt-2'>
                                        ...
                                        <div className='flex justify-center items-center gap-4'>
                                            ...
                                            <div className='p-2 border-2 border-gray-200 hover:bg-black
                                              cursor-pointer transform hover:scale-110 transition-transform duration-300'>
                                                <FaPlus className='size-4 text-blue-400' />
                                            </div>
